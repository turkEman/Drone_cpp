...
//     angle_gx += gx * 0.0000611;
//     angle_gy += gy * 0.0000611;

//     // extracting angle from accl data
//     angle_ax = atan(ax / sqrt(ay * ay + az * az)) * 180 / PI;
//     angle_ay = atan(ay / sqrt(ax * ax + az * az)) * 180 / PI;
// }

#include <Arduino.h>
#include <Wire.h>

unsigned long previous_time = 0, current_time = 0, delta_time = 0;
